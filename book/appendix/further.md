---
title: "Appendix F — Further Reading: The 2026 Shelf"
layout: default
---

<div class="chapter-meta"><b>Original:</b> Epilogue / "further reading" in spirit (the original book ends with guidance by committee). <b>Verdict:</b> KEEP — with this edition's 2026 shelf. <b>Reading time:</b> 4 minutes.</div>

# Appendix F — Further Reading: The 2026 Shelf

The original book's immense value is that it pointed outside itself — to Google SRE, NIST, IEEE, the DORA research (a grounding that this book never had, which is fine; the original is *the* grounding). This is the 2026 shelf: the same honesty, updated.
...
<div class="callout">
  ...
  <p><b>The next book you read should betray this one on every page.</b> The durability of SRE is not that its answers stay true; it's that its <i>method</i> — budget, evidence, rehearsal, blamelessness — stays a <i>method</i> even as the stack (and now the crew) turns over. Keep the shelf alive; the machines will help you read it, but only you get to decide what to believe.</p>
</div>

<p><a href="../part6/ch36/">Next: Read the closing chapter — the handoff to the humans</a> →</p>