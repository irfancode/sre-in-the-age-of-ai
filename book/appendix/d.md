...
4. **The doc gates autonomy.** In [Chapter 24](part4/ch24/)'s autonomy ladder, the "current autonomy state" block is what the leash checks. Update it *first* when the incident changes character.

<div class="callout">
  <span class="tag"><i class="fa-solid fa-lightbulb"></i> Key insight</span>
  <p><b>The incident doc is where the human-made and machine-made reliability meet and are reconciled.</b> It does not make incidents boring — it makes them <i>rehearsable</i> [Ch 12](part3/ch12/), and every chapter in Part IV exists to keep this one document honest at scale.</p>
</div>
